            ...
            <form className="flex flex-col justify-center mx-auto ">
                <div className="mx-auto ">
                    ...
                    <div className="mt-2 py-2 px-1 flex flex-col">
                        ...
                        <input type="text" name="dayDesc" id="dayDesc" className="border rounded border-slate-400 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-400 " required />
                    </div>
                    <div className="mt-2 py-2 px-1 flex flex-col">
                        <label htmlFor="yogaDes" className="font-bold text-slate-500">Yoga Description</label>
                        <input type="text" name="yogaDes" id="yogaDes" className=" border rounded border-slate-400 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-400 " required />
                    </div>
                    <div className="mt-2 py-2 px-1 flex flex-col">
